  ...
  return (
    <div className="w-full h-full flex flex-col">
      <div className="w-full h-full flex flex-col items-center relative">
          <img src="https://picsum.photos/700/200" className="w-full h-[200px] object-cover absolute top-0" />
        <div className="w-full  flex flex-col  gap-3 absolute top-[100px] p-5">
          ...
          <div className="h-full flex flex-col justify-center gap-1">
            ...
            <button className="text-sm rounded-lg border w-fit px-2 hover:bg-bg-emphasized">edit profile</button>
          </div>
        <p className="text-sm">
          {one_user?.bio}
