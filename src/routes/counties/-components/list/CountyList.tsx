...
import { listCountyQueryOptions } from "./counties-query-options";

interface CountyListProps {
  q: string;
}

export function CountyList({ q = "" }: CountyListProps) {
  const query = useSuspenseQuery(listCountyQueryOptions({ search_query: q }));
