...
import { listGovernorsQueryOptions } from "./governors-query-options";


interface GovernorListProps {
  q: string;
}

export function GovernorList({ q = "" }: GovernorListProps) {
  const query = useSuspenseQuery(listGovernorsQueryOptions({ search_query: q }));
